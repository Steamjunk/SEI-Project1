...
class GameObject {
    ...
    gameOver() {
        ...
        this.endGameText.innerText = "Game Over! Face the wrath of the Pharaoh";
    ...
    toggleSceneHide() {
        if(this.sceneHidden) {
            ...
            document.querySelector('#ground').classList.remove('hidden');

            document.querySelector('#end-game-scene').classList.add('hidden');
            this.endGameText.remove();


            // if(document.querySelector('.end-game-image')) {
            //     console.log('test');
            //     document.querySelector('.end-game-image').remove();
            //     document.querySelector('.end-game-text').innerText = '';
            // }
        } else {
