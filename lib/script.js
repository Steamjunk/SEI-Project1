...
class GameObject {
    constructor(pyramidSize, timeLimitseconds) {
        ...
        this.scene = document.querySelector('#sceneWrapper');
    ...
    startTimer() {
        ...
        function randomPosition() {
            document.querySelector('#sun').style.left = `${Math.random() * window.innerWidth}px`;
            document.querySelector('#sun').style.top = `${Math.random() * window.innerHeight}px`;
          }
